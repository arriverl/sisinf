...
echo "# 类一"
echo "python3 scripts/sis_run.py batch --class 1 --full-max --max-rounds 24 --seed 20260603"
echo "# 类二"
echo "python3 scripts/sis_run.py batch --class 2 --full-max --max-rounds 24 --seed 20260603"
echo "# 类三"
echo "python3 scripts/sis_run.py batch --class 3 --full-max --max-rounds 24 --seed 20260603"
echo ""
